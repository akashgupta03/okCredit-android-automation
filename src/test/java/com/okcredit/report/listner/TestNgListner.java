package com.okcredit.report.listner;
import com.okcredit.report.ExtentManager;
import com.okcredit.report.ExtentTestManager;
...
public class TestNgListner implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (!result.isSuccess()) {
            File imageFile = ((TakesScreenshot) AndroidDriverBuilder.driver).getScreenshotAs(OutputType.FILE);
